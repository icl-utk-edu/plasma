    ...
    if (side == PlasmaLeft) {
        ...
        if (uplo == PlasmaUpper) {
            ...
            //=================================================
                ...
                for (k = 0; k < B.nt; k++) {
                    tempkn = plasma_tile_nview(B, B.nt-k-1);
